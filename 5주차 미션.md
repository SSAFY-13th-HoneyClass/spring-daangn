...
![AccessToken 없이 API 호출 에러](img/accesstoken없이%20api%20호출%20에러.png)
...
![AccessToken 포함 API 호출 성공](img/accesstoken포함%20api%20호출%20성공.png)
...
![RefreshToken Cookie 이전의 로그인](img/refreshtoken%20cookie%20이전의%20로그인.png)
...
![RefreshToken Cookie 이후의 로그인](img/refreshtoken%20cookie%20이후의%20로그인.png)
...
#### 🔄 **자동 토큰 재발급 시스템**
![RefreshToken Cookie를 이용한 AccessToken 재발급](img/refreshtoken%20cookie를%20이용한%20accesstoken%20재발급.png)
